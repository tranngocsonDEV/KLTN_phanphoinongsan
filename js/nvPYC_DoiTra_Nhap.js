$(document).ready(function () {
  ...
  var table = $("#example").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: "../php/nvPYC_DoiTra_HienThi_Nhap.php",
      type: "POST",
      data: function (d) {
        d.action = "fetchData";
    ...
    columns: [
      ...
      { data: "NgayLapPhieu" },
      {
        ...
        render: function (data, type, row) {
          let actionBtns = `<a href='./nvPYC_DoiTra_ChiTiet_Nhap.php?MaYeuCauDoiTra=${row.MaYeuCauDoiTra}' class='btn btn-primary btn-md h-100 fs-6'>Xem</a>`;
