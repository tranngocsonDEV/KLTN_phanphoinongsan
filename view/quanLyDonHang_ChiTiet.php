...
?>
    ...
    <main class="mt-5 pt-3">
        <div class="container-fluid">
            <div class="row">
            <div class="col-md-12 fw-bold fs-3" id="du-lieu-title" data-title="Chi tiết đơn hàng">Chi tiết đơn hàng</div>
            </div>
                        ...
                        <div class="card-body">
                            <dl class="row">
                                ...
                                if (isset($_GET['MaPhieu'])) {
                                    $MaPhieu = $_GET['MaPhieu']; // $id only exists within the scope of this block
                                }
                                // Thực hiện truy vấn và hiển thị thông tin chi tiết
                                $sql = "SELECT pyc.MaPhieu, lp.TenLoai, s.manhanvien as s_shipper,pyc.NgayGiaoHang, pyc.TrangThai, pyc.GhiChu,
                                ...
                                JOIN tbl_shipper AS s
                                ON pyc.MaShipper=s.MaShipper
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<dt class='col-sm-3'>Người giao hàng:</dt>";
                                        echo "<dd class='col-sm-9'>" . $row['s_shipper'] . "</dd>";
                            ...
                            <div class="buttons">
                                <div class="d-grid gap-2 d-md-block">
                                    <a href="./quanLyDonHang.php" class="btn btn-secondary btn-lg" tabindex="-1" role="button" aria-disabled="true">Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </div>
