        ...
        <div class="card">
          ...
          <div class="card-body">
            <dl class="row">
              ...
              $sql = "SELECT px.MaPhieuXuat AS MaPhieuXuatKho, lp.Ten AS Ten, nvk.IDNhanVien AS NhanVienKho, u.Ten AS NhanVienKho,
                       NgayLapPhieu, NgayXuatHang, NgayGiaoHang, TongSoLoaiSanPham, tbl_a_trangthaiphieuyeucau.Ten AS TenTrangThai ,
                       GhiChu, kh.MaKhachHang AS MaKhachHang, 
                      ...
                      ON px.MaTrangThaiPhieu = tbl_a_trangthaiphieuyeucau.MaTrangThaiPhieu
                      ...
                      ON px.MaKhachHang = kh.MaKhachHang
                      JOIN tbl_user AS u 
                      ON nvk.IDNhanVien = u.IDNhanVien
                      JOIN tbl_thanhtoan AS tt
                      ON tt.MaPhieuXuat = px.MaPhieuXuat
              ...
              if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<dt class='col-sm-3'>Mã khách hàng:</dt>";
            ...
            <div class="buttons">
              <div class="d-grid gap-2 d-md-block">
                ...
                <a href="./nvPhieuYeuCau_Xuat.php" class="btn btn-secondary btn-lg" tabindex="-1" role="button"
