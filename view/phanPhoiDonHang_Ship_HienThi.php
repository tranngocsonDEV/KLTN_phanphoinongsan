                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            $sql = "SELECT DISTINCT tbl_phieuxuat.MaPhieuXuat AS MaPhieuXuatKho, lp.Ten AS Ten, nvk.IDNhanVien AS IDNhanVienKho, u1.Ten AS NhanVienKho,
                      ...
                      JOIN tbl_user AS u1 ON nvk.IDNhanVien = u1.IDNhanVien
                      ...
                      WHERE tbl_phieuxuat.MaPhieuXuat= '$MaPhieuXuat'";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<dt class='col-sm-3'>Nhân viên giao hàng:</dt>";
                                    echo "<dd class='col-sm-9'>" . $row['TenNhanVienGiaoHang'] . "</dd>";
                                    echo "</dl>";
                                    echo "</div>";
                  ...
                  WHERE px.MaPhieuXuat = '$MaPhieuXuat '";
                        ...
                        <div class="buttons">
                            <div class="d-flex flex-row gap-1">
                                ...
                                <a href="./phanPhoiDonHang.php" class="btn btn-secondary btn-lg" tabindex="-1"
