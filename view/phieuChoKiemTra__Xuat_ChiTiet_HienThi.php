                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            $sql = "SELECT tbl_phieuxuat.MaPhieuXuat AS MaPhieu, lp.Ten AS Ten, nvk.IDNhanVien AS IDNhanVienKho, u.Ten AS NhanVienKho,
                      ...
                      WHERE tbl_phieuxuat.MaPhieuXuat= '$MaPhieu'";
                  ...
                  WHERE px.MaPhieuXuat = '$MaPhieu'";
                        ...
                        <div class="buttons">
                            ...
                            <div class="d-flex flex-row gap-1">
                                <!-- Nút Đạt tiêu chuẩn -->
                                <form action="phieuChoKiemTra_Xuat_ChiTiet_Duyet.php" method="get">
                                ...
                                <form action="#" method="get">
                                    <input type="hidden" name="MaPhieuXuatKho" value="<?= $MaPhieu ?>" />
...
<script>
    document.querySelectorAll('.btn_request_deny').forEach(button => {
        button.addEventListener('click', function (event) {
            ...
            const maPhieu = this.closest('form').querySelector('input[name="MaPhieuXuatKho"]').value;
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="denyForm" method="get" action="nvkkLapBienBan_Xuat.php">
                    <input type="hidden" name="MaPhieuXuatKho" id="MaPhieuInput">
