                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            $sql = "SELECT DISTINCT 
                            bb.MaBienBan AS MaBienBanCuaPhieu,bb.LyDo AS LyDoLapBienBan, bb.NgayLapBienBan,pn.MaPhieuNhap, u1.Ten AS NguoiLapBienBan,
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<dt class='col-sm-3'>Kết quả kiểm tra:</dt>";
